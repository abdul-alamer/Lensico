 ...
 */
public class GetFollowsTask extends AsyncTask<Object, Void, List<SimpleInstagramUser>> {
    ...
    protected List<SimpleInstagramUser> doInBackground(Object... params) {
        ...
        try {
            String url = "https://api.instagram.com/v1/users/" + params[0] + "/follows?access_token=" + params[1];
            StringUtil.log(url);
            ...
            for (int data_i = 0; data_i < data.length(); data_i++) {
                ...
                user.picUri = data_obj.getString("profile_picture");
                users.add(user);
            }
            return users;
