 ...
 */
public class SendLikeTask extends AsyncTask<Object, Void, Integer> {
    ...
    protected Integer doInBackground(Object... params) {
        ...
        int returnCode = jsonParser.sendPostRequest("https://api.instagram.com/v1/media/" + params[0] + "/likes?access_token=" + params[1]);
        if (returnCode == 200) {
            return returnCode;
        } else {
            return null;
